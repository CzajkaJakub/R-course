...
# your performance at the tables and fire off your career as a professional gambler.
# This chapter will show how you can easily keep track of your betting progress
...
# such as the days of the week. However, when you look at it from a higher perspective, there is a more efficient way to do
# this, namely, to assign the days of the week vector to a variable!
#
...
#Ex comparing total winning

# Oops, it seems like you are losing money. Time to rethink and adapt your strategy! This will require some deeper analysis…
#
# After a short brainstorm in your hotel's jacuzzi, you realize that a possible explanation might be that your skills in
# roulette are not as well developed as your skills in poker. So maybe your total gains in poker are higher (or > ) than in roulette.
...
#
# To answer that question, you only want to focus on a selection of the total_vector. In other words, our goal is to
# select specific elements of the vector. To select elements of a vector (and later matrices, data frames, …), you can use square brackets.
...
# You can indicate between the brackets what elements should be selected. For example: suppose you want to select the
# first and the fifth day of the week: use the vector c(1, 5) between the square brackets. For example,
# the code below selects the first and fifth element of poker_vector:
#
# poker_vector[c(1, 5)]
#To select the second element of the vector, you type poker_vector[2], etc. Notice that the first element in a vector has index 1, not 0 as in many other programming languages.
# Poker and roulette winnings from Monday to Friday:
poker_vector <- c(140, -50, 20, -120, 240)
roulette_vector <- c(-24, -50, 100, -350, 10)
days_vector <- c("Monday", "Tuesday", "Wednesday", "Thursday", "Friday")
