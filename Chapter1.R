...
#
# A variable allows you to store a value (e.g. 4) or an object (e.g. a function description) in R. You can then
...
# ppose you have a fruit basket with five apples. As a data analyst in training,
...
# 5Every tasty fruit basket needs oranges, so you decide to add six oranges. As a data analyst,
# your reflex is to immediately create the variable my_oranges and assign the value 6 to it.
...
# and assigned a text value to the variable my_oranges (see the editor), you would be trying to assign the addition of a numeric
# and a character variable to the variable my_fruit. This is not possible.
...
#Ex 7 Basic types in R

# RR works with numerous data types. Some of the most basic types to get started are:
#
